...
class logDSubmission(SamplSubmission):
    ...
    # Sections in CSV format with columns names.
    CSV_SECTIONS = {"Octanol-water predictions": ("Molecule ID", "ID tag", "logD mean", "logD SEM", "logD model uncertainty"),
                    "Cyclohexane-water predictions": ("Molecule ID", "ID tag", "logD mean", "logD SEM", "logD model uncertainty"),
                    "Ethyl acetate-water predictions": ("Molecule ID", "ID tag", "logD mean", "logD SEM", "logD model uncertainty"),
                    "Heptane-water predictions": ("Molecule ID", "ID tag", "logD mean", "logD SEM", "logD model uncertainty"),
                    "MEK-water predictions": ("Molecule ID", "ID tag", "logD mean", "logD SEM", "logD model uncertainty"),
